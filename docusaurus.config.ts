    ...
    const community =
        [
          ...
          },
          {
            label: 'Slack',
            href:
                'https://join.slack.com/t/oceanbase/shared_invite/zt-1e25oz3ol-lJ6YNqPHaKwY_mhhioyEuw',
          },
          {
    ...
    const config: Config = {
      ...
      themeConfig: {
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  href:
                      'https://oceanbase-devhub.github.io/dify/dify@oceanbase-workshop',
                },
                {
                  label: 'DB-GPT',
                  href:
                      'https://oceanbase-devhub.github.io/DB-GPT/docker/compose_examples/ob_dbgpt_tutorial',
                },
              ],
            },
            {
        ...
        footer: {
          ...
          copyright: `Copyright © ${
              new Date().getFullYear()} OceanBase, Inc. Built with Docusaurus.`,
        },
        prism: {
