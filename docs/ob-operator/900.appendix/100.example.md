...
* [OceanBase Cloud Platform (OCP)](https://hub.docker.com/r/oceanbase/ocp-ce). OCP is taken as an example to describe how to deploy web applications in the Kubernetes cluster.
...
OCP is taken as an example to describe how to deploy a web application.
Create databases
Run the following command to create databases:
